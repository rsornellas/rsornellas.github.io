  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        <ul
          class="uppercase tracking-wide font-bold w-full block flex-grow lg:space-x-8 space-y-6 lg:space-y-0 lg:flex justify-center lg:w-auto items-center mt-8 lg:mt-0"
        ...
        >
          ...
          <li>
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'" class="text-copy-primary hover:text-gray-600">Projetos</a>
            <g-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">Projetos</g-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#about" v-scroll-to="'#about'" class="text-copy-primary hover:text-gray-600">Sobre</a>
            <g-link v-else to="/#about" class="text-copy-primary hover:text-gray-600">Sobre</g-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#contact" v-scroll-to="'#contact'" class="text-copy-primary hover:text-gray-600">Contatos</a>
            <g-link v-else to="/#contact" class="text-copy-primary hover:text-gray-600">Contatos</g-link>
          </li>
        </ul>
      </nav>
    </header>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:rsornellas91@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/rsornellas/" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/raphaelornellas/" target="_blank" class="text-white hover:text-gray-400">
